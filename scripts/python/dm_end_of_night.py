...
# +
# function: dm_end_of_night()
# -
def dm_end_of_night(entity_name='', entity_object=None):
...
# +
# function: dm_end_of_night_main()
# -
def dm_end_of_night_main(*args):

    # create jobs for each argument:
    jobs = []
    for E in args:
        j = threading.Thread(target=dm_end_of_night, args=(E._entity, E))
        jobs.append(j)
        j.start()
...
if __name__ == "__main__":
    dm_end_of_night_main(OcsGenericEntity('DMCS', 'Archiver', False), 
