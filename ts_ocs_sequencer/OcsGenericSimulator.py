...
# __doc__ string
# -
__doc__ = """Simulator for generic command set of a commandable entity"""
...
__file__ = "OcsGenericSimulator.py"
...
# +
# class: GenericSimulator() inherits from threading.Thread
# -
   ...
   # get command line argument
    ...
    try:
        ...
        for T in ['abort', 'disable', 'enable', 'enterControl', 'exitControl', 'standby', 'start', 'stop']:
            t = GenericSimulator(T, entity, event_processor, state_machine)
            threads.append(t)
            t.start()
