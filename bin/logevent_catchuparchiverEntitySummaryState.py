...
# __doc__ string
# -
__doc__ = """Event logger for specific event in the DMCS CatchupArchiver"""
...
__file__ = "logevent_catchuparchiverEntitySummaryState.py"
...
if __name__ == "__main__":
    ...
    # get a logger
    evlog = OcsLogger('Events', 'catchuparchiverEntitySummaryState')
    ...
    mgr.salEvent('catchuparchiver_logevent_catchuparchiverEntitySummaryState')

    # create event container
    event = catchuparchiver_logevent_catchuparchiverEntitySummaryStateC()
    ...
    # loop forever
    while True:
        retval = mgr.getEvent_catchuparchiverEntitySummaryState(event)
        if retval == 0:
