...
# __doc__ string
# -
__doc__ = """Event logger for specific event in the DMCS ProcessingCluster"""
...
__file__ = "logevent_processingclusterEntitySummaryState.py"
...
if __name__ == "__main__":
    ...
    # get a logger
    evlog = OcsLogger('Events', 'processingclusterEntitySummaryState')
    ...
    mgr.salEvent('processingcluster_logevent_processingclusterEntitySummaryState')

    # create event container
    event = processingcluster_logevent_processingclusterEntitySummaryStateC()
    ...
    # loop forever
    while True:
        retval = mgr.getEvent_processingclusterEntitySummaryState(event)
        if retval == 0:
